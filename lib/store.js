...
const KEY = 'yt-store';
const INIT = { likes: {}, subscriptions: {}, history: [], user: null };
...
export function StoreProvider({ children }) {
  ...
  return (
    <Ctx.Provider
      value={{ ...store, toggleLike, toggleSubscribe, addHistory, login, logout, isLiked, isSubscribed }}
    >
      {children}
    </Ctx.Provider>
  );
