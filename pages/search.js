  ...
  return (
    <div className="yt-res-card" style={{ pointerEvents: "none" }}>
      ...
      <div style={{ flex: 1, paddingTop: 4 }}>
        <div
          className="yt-skel"
          style={{ height: 20, marginBottom: 10, width: "80%" }}
        />
        <div
          className="yt-skel"
          style={{ height: 13, marginBottom: 8, width: "40%" }}
        />
...
export default function SearchPage() {
  ...
  return (
    <PageLayout
      title={q ? q + " - YouTube" : "Search - YouTube"}
      defaultSidebar="mini"
    >
      {error && (
            ...
            return (
              ...
              >
                <div className="yt-res-thumb">
                  {thumb && (
                    <img src={thumb} alt={item.snippet.title} loading="lazy" />
                  )}
                </div>
                <div className="yt-res-info">
                  ...
                  <div className="yt-res-ch">
                    ...
                    <CheckCircleFilled
                      style={{ color: "#717171", fontSize: 12 }}
                    />
                  </div>
